...
IF NOT EXIST %LOG_LOCATION%\var\var_TimeZone.txt (
	...
	) && IF EXIST "%LOG_LOCATION%\var\var_TimeZone.txt" IF %LOG_LEVEL_DEBUG% EQU 1 ECHO %ISO_DATE% %TIME% [DEBUG]	File [var_TimeZone.txt] created! >> %LOG_LOCATION%\%LOG_FILE% 
...
IF %LOG_LEVEL_INFO% EQU 1 ECHO %ISO_DATE% %TIME% [INFO]	SCRIPT: %SCRIPT_NAME% %SCRIPT_VERSION% >> %LOG_LOCATION%\%LOG_FILE%
IF %LOG_LEVEL_INFO% EQU 1 ECHO %ISO_DATE% %TIME% [INFO]	SCRIPT BUILD: %SCRIPT_BUILD% >> %LOG_LOCATION%\%LOG_FILE%
IF %LOG_LEVEL_INFO% EQU 1 ECHO %ISO_DATE% %TIME% [INFO]	Computer: %COMPUTERNAME% >> %LOG_LOCATION%\%LOG_FILE%
IF %LOG_LEVEL_INFO% EQU 1 ECHO %ISO_DATE% %TIME% [INFO]	User: %USERNAME% >> %LOG_LOCATION%\%LOG_FILE%
...
IF %LOG_LEVEL_DEBUG% EQU 1 IF %$ADMIN_STATUS% EQU 0 ECHO %ISO_DATE% %TIME% [DEBUG]	Running with administrative privilege. >> %LOG_LOCATION%\%LOG_FILE%
...
IF %LOG_LEVEL_TRACE% EQU 1 ECHO %ISO_DATE% %TIME% [TRACE]	ENTER: License Server update... >> %LOG_LOCATION%\%LOG_FILE%
REG QUERY HKEY_LOCAL_MACHINE\SOFTWARE\ESRI\ArcGISPro /V REALVERSION 2> nul
SET $LSU_ERROR=%ERRORLEVEL%
IF %LOG_LEVEL_DEBUG% EQU 1 ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: $LSU_ERROR: %$LSU_ERROR% >> %LOG_LOCATION%\%LOG_FILE%
...
IF %LOG_LEVEL_DEBUG% EQU 1 ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: $ARCGIS_LICENSE_HKEY: %$ARCGIS_LICENSE_HKEY% >> %LOG_LOCATION%\%LOG_FILE%
...
IF %LOG_LEVEL_DEBUG% EQU 1 ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: $ARCGIS_LICENSE_HKEY_VALUE: %$ARCGIS_LICENSE_HKEY_VALUE% >> %LOG_LOCATION%\%LOG_FILE%
...
IF %LOG_LEVEL_DEBUG% EQU 1 ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: $ARCGIS_AUTHORIZATION_TYPE_HKEY_VALUE: %$ARCGIS_AUTHORIZATION_TYPE_HKEY_VALUE% >> %LOG_LOCATION%\%LOG_FILE%
:skipLSU
IF %LOG_LEVEL_TRACE% EQU 1 ECHO %ISO_DATE% %TIME% [TRACE]	EXIT: License Server update. >> %LOG_LOCATION%\%LOG_FILE%
...
IF DEFINED ARCGISPRO_VERSION IF %LOG_LEVEL_INFO% EQU 1 ECHO %ISO_DATE% %TIME% [INFO]	Found ARCGISPRO Version: %ARCGISPRO_VERSION% >> %LOG_LOCATION%\%LOG_FILE%
IF NOT DEFINED ARCGISPRO_VERSION IF %LOG_LEVEL_INFO% EQU 1 ECHO %ISO_DATE% %TIME% [INFO]	ArcGIS Pro not installed! First time installation! >> %LOG_LOCATION%\%LOG_FILE%
...
IF DEFINED ARCGISPRO_UPDATE IF %LOG_LEVEL_INFO% EQU 1 ECHO %ISO_DATE% %TIME% [INFO]	Found ARCGISPRO Patch: %ARCGISPRO_UPDATE% >> %LOG_LOCATION%\%LOG_FILE%
IF NOT DEFINED ARCGISPRO_UPDATE IF %LOG_LEVEL_INFO% EQU 1 ECHO %ISO_DATE% %TIME% [INFO]	ArcGIS Pro patches not installed! >> %LOG_LOCATION%\%LOG_FILE%
...
IF %LOG_LEVEL_DEBUG% EQU 1 ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: ARCGISPRO_FOLDER: %ARCGISPRO_FOLDER% >> %LOG_LOCATION%\%LOG_FILE%
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
IF %LOG_LEVEL_TRACE% EQU 1 ECHO %ISO_DATE% %TIME% [TRACE]	ENTER: Microsoft .NET SDK... >> %LOG_LOCATION%\%LOG_FILE%
ECHO Working on Microsoft dot NET SDK Dependency...
SET $INSTALL_DOTNET=0
where dotnet 2>nul || SET $INSTALL_DOTNET=1
IF %LOG_LEVEL_DEBUG% EQU 1 ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: $INSTALL_DOTNET: %$INSTALL_DOTNET% >> %LOG_LOCATION%\%LOG_FILE%
...
IF %LOG_LEVEL_TRACE% EQU 1 ECHO %ISO_DATE% %TIME% [TRACE]	ENTER: Microsoft .NET SDK download... >> %LOG_LOCATION%\%LOG_FILE%
IF %LOG_LEVEL_INFO% EQU 1 ECHO %ISO_DATE% %TIME% [INFO]	installing Microsoft .NET SDK >> %LOG_LOCATION%\%LOG_FILE%
...
IF %LOG_LEVEL_DEBUG% EQU 1 ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: $NET_SDK: %$NET_SDK% >> %LOG_LOCATION%\%LOG_FILE%
IF %LOG_LEVEL_TRACE% EQU 1 ECHO %ISO_DATE% %TIME% [TRACE]	EXIT: Microsoft .NET SDK download. >> %LOG_LOCATION%\%LOG_FILE%
%$NET_SDK% /install /quiet /log "%LOG_LOCATION%\MS_NET_SDK.txt"
SET $NET_SDK_ERROR=%ERRORLEVEL%
IF %LOG_LEVEL_DEBUG% EQU 1 ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: $NET_SDK_ERROR: %$NET_SDK_ERROR% >> %LOG_LOCATION%\%LOG_FILE%
IF %$NET_SDK_ERROR% EQU 0 IF %LOG_LEVEL_INFO% EQU 1 ECHO %ISO_DATE% %TIME% [INFO]	dotNET-SDK {%$NET_SDK%} installed. >> %LOG_LOCATION%\%LOG_FILE%
echo dotNET-SDK {%$NET_SDK%} installed.
:skipNET
IF %LOG_LEVEL_TRACE% EQU 1 ECHO %ISO_DATE% %TIME% [TRACE]	EXIT: Microsoft .NET SDK. >> %LOG_LOCATION%\%LOG_FILE%
...
:: ArcGIS Pro Updates
IF %LOG_LEVEL_INFO% EQU 1 ECHO %ISO_DATE% %TIME% [INFO]	Checking if patch installer should run... >> %LOG_LOCATION%\%LOG_FILE%
...
FOR /F "tokens=3-5 delims=^(^)." %%P IN ('REG QUERY HKEY_LOCAL_MACHINE\SOFTWARE\ESRI\ArcGISPro\Updates /S /v "NAME" ^| FIND /I "Name"') DO (dir /b /A:-D "%PACKAGE_SOURCE%\%ARCGISPRO_FOLDER%" | FIND /I "%%P%%Q%%R") && SET PACKAGE_ALREADY_INSTALLED=1
IF %LOG_LEVEL_DEBUG% EQU 1 ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: PACKAGE_ALREADY_INSTALLED: %PACKAGE_ALREADY_INSTALLED% >> %LOG_LOCATION%\%LOG_FILE%
IF %PACKAGE_ALREADY_INSTALLED% EQU 1 IF %LOG_LEVEL_INFO% EQU 1 ECHO %ISO_DATE% %TIME% [INFO]	ArcGIS Pro update package {%ARCGISPRO_UPDATE_PACKAGE%} already installed! >> %LOG_LOCATION%\%LOG_FILE%
...
IF NOT EXIST "%PACKAGE_DESTINATION%\%ARCGISPRO_FOLDER%\%ARCGISPRO_UPDATE_PACKAGE%" ROBOCOPY "%PACKAGE_SOURCE%\%ARCGISPRO_FOLDER%" "%PACKAGE_DESTINATION%\%ARCGISPRO_FOLDER%" /NP /NDL /NFL /R:2 /W:5 *.msp /LOG+:"%LOG_LOCATION%\%LOG_FILE%"

:runAPP
:: Execute the update package
IF %LOG_LEVEL_INFO% EQU 1 ECHO %ISO_DATE% %TIME% [INFO]	Installing ArcGIS Pro [%ARCGISPRO_UPDATE_PACKAGE%] patch... >> %LOG_LOCATION%\%LOG_FILE%
...
IF %LOG_LEVEL_DEBUG% EQU 1 ECHO %ISO_DATE% %TIME% [DEBUG]	ARCGIS_UPDATE_ERROR: %ARCGIS_UPDATE_ERROR% >> %LOG_LOCATION%\%LOG_FILE%
...
IF %LOG_LEVEL_INFO% EQU 1 ECHO %ISO_DATE% %TIME% [INFO]	Current ARCGISPRO Version: %ARCGISPRO_VERSION% >> %LOG_LOCATION%\%LOG_FILE%
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: ISO_MONTH: %ISO_MONTH% >> %LOG_LOCATION%\%LOG_FILE%
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: ISO_DAY: %ISO_DAY% >> %LOG_LOCATION%\%LOG_FILE%
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: ISO_YEAR: %ISO_YEAR% >> %LOG_LOCATION%\%LOG_FILE%
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: ISO_DATE: %ISO_DATE% >> %LOG_LOCATION%\%LOG_FILE%
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: PS_STATUS: %PS_STATUS% >> %LOG_LOCATION%\%LOG_FILE%
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: PS_MAJOR_VERSION: %PS_MAJOR_VERSION% >> %LOG_LOCATION%\%LOG_FILE%
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: PS_MINOR_VERSION: %PS_MINOR_VERSION% >> %LOG_LOCATION%\%LOG_FILE%
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: PS_BUILD_VERSION: %PS_BUILD_VERSION% >> %LOG_LOCATION%\%LOG_FILE%
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: PS_REVISION_VERSION: %PS_REVISION_VERSION% >> %LOG_LOCATION%\%LOG_FILE%
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: $INSTALL_DOTNET: %$INSTALL_DOTNET% >> %LOG_LOCATION%\%LOG_FILE%
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: $DOTNET_VERSION: %$DOTNET_VERSION% >> %LOG_LOCATION%\%LOG_FILE%
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: $NET_SDK_PACKAGE_VERSION: %$NET_SDK_PACKAGE_VERSION% >> %LOG_LOCATION%\%LOG_FILE%
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: $NET_SDK: %$NET_SDK% >> %LOG_LOCATION%\%LOG_FILE%
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: $NET_SDK_ERROR: %$NET_SDK_ERROR% >> %LOG_LOCATION%\%LOG_FILE%
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: $INSTALLDIR: %$INSTALLDIR% >> %LOG_LOCATION%\%LOG_FILE%
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: $ALLUSERS: %$ALLUSERS% >> %LOG_LOCATION%\%LOG_FILE%
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: $ENABLEEUEI: %$ENABLEEUEI% >> %LOG_LOCATION%\%LOG_FILE%
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: $ACCEPTEULA=%$ACCEPTEULA% >> %LOG_LOCATION%\%LOG_FILE%
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: $BLOCKADDINS: %$BLOCKADDINS% >> %LOG_LOCATION%\%LOG_FILE%
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: $CHECKFORUPDATESATSTARTUP: %$CHECKFORUPDATESATSTARTUP% >> %LOG_LOCATION%\%LOG_FILE%
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: $ESRI_LICENSE_HOST: %$ESRI_LICENSE_HOST% >> %LOG_LOCATION%\%LOG_FILE%
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: $SOFTWARE_CLASS: %$SOFTWARE_CLASS% >> %LOG_LOCATION%\%LOG_FILE%
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: $AUTHORIZATION_TYPE: %$AUTHORIZATION_TYPE% >> %LOG_LOCATION%\%LOG_FILE%
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: $LOCK_AUTH_SETTINGS: %$LOCK_AUTH_SETTINGS% >> %LOG_LOCATION%\%LOG_FILE%
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: $ArcGIS_Connection: %$ArcGIS_Connection% >> %LOG_LOCATION%\%LOG_FILE%
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: $Portal_List: %$Portal_List% >> %LOG_LOCATION%\%LOG_FILE%
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: $License_URL: %$License_URL% >> %LOG_LOCATION%\%LOG_FILE%
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: PACKAGE_SOURCE: %PACKAGE_SOURCE% >> %LOG_LOCATION%\%LOG_FILE%
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: PACKAGE_DESTINATION: %PACKAGE_DESTINATION% >> %LOG_LOCATION%\%LOG_FILE%
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: ARCGISPRO_FOLDER: %ARCGISPRO_FOLDER% >> %LOG_LOCATION%\%LOG_FILE%
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: ARCGISPRO_INSTALL_ERROR: %ARCGISPRO_INSTALL_ERROR% >> %LOG_LOCATION%\%LOG_FILE%
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: ARCGIS_UPDATE_ERROR: %ARCGIS_UPDATE_ERROR% >> %LOG_LOCATION%\%LOG_FILE%
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: ARCGISPRO_VERSION: %ARCGISPRO_VERSION% >> %LOG_LOCATION%\%LOG_FILE%
ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: ARCGISPRO_PATCH: %ARCGISPRO_PATCH% >> %LOG_LOCATION%\%LOG_FILE%
...
IF %LOG_LEVEL_DEBUG% EQU 1 ECHO %ISO_DATE% %TIME% [DEBUG]	VARIABLE: TOTAL_TIME: %TOTAL_TIME% >> %LOG_LOCATION%\%LOG_FILE%
IF %LOG_LEVEL_INFO% EQU 1 ECHO %ISO_DATE% %TIME% [INFO]	Time Lapsed (hh:mm:ss): %TOTAL_TIME% >> %LOG_LOCATION%\%LOG_FILE%
:skipELT
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
IF NOT EXIST "%LOG_LOCATION%\var" IF %LOG_LEVEL_DEBUG% EQU 1 ECHO %ISO_DATE% %TIME% [DEBUG]	var folder deleted! >> %LOG_LOCATION%\%LOG_FILE%
IF EXIST "%PACKAGE_DESTINATION%\%ARCGISPRO_FOLDER%" RD /S /Q "%PACKAGE_DESTINATION%\%ARCGISPRO_FOLDER%"
IF NOT EXIST "%PACKAGE_DESTINATION%"  IF %LOG_LEVEL_DEBUG% EQU 1 ECHO %ISO_DATE% %TIME% [DEBUG]	ArcGIS Pro staging area deleted! >> %LOG_LOCATION%\%LOG_FILE%
:skipClean
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
